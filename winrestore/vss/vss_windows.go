...
type VSS_ID = windows.GUID
type VSS_TIMESTAMP int64

// Go representation of the VSS_SNAPSHOT_PROP structure from the Windows SDK
...
// We return these results as a complete SnapshotList (as opposed to a channel-based
// implementation) because we need to be able to access the snapshot information in
